				...
				<div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
					<div class="p-4 m-3">
						...
						<form method="POST" accept="login_phase2" class="needs-validation" novalidate="">
							...
							<div class="form-group">
								<label for="otp_val">OTP Code / Check In Your Email</label>
								<input id="otp_val" type="text" class="form-control" name="otp_val" tabindex="1" required autofocus>
								<div class="invalid-feedback">
									Please fill in your OTP Code
								</div>
							</div>
